...
public class AlumnoJpaController implements Serializable {
        ...
        try {
            ...
            if (msg == null || msg.length() == 0) {
                ...
                if (findAlumno(id) == null) {
                    throw new NonexistentEntityException("The alumno with id " +
                            id + " no longer exists.");
                }
            }
            throw ex;
    ...
    public void destroy(int id) throws NonexistentEntityException {
        ...
        try {
            ...
            try {
                ...
                throw new NonexistentEntityException("The alumno with id " + id +
    ...
    private List<Alumno> findAlumnoEntities(boolean all, int maxResults,
            int firstResult) {
